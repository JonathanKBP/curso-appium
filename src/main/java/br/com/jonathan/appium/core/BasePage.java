...
public class BasePage {
	...
	public void swipe(double inicio, double fim) {
		...
		new TouchAction<>(getDriver()).longPress(PointOption.point(new Point(start_x, y)))
				.waitAction(WaitOptions.waitOptions(Duration.ofMillis(500)))
	...
	public void cliqueLongo(By by) {
		new TouchAction<>(getDriver()).longPress(PointOption.point(getDriver().findElement(by).getCenter())).release()
				.perform();
	}
}
